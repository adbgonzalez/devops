...
Estas máquinas virtuais estarán nunha **Rede NAT**, o que permitirá:
...
Estas non son normas fixas, senón **indicacións**.  
O usuario pode optar por:

- empregar outro hipervisor (como VMware Workstation Player)  
- ou recrear o escenario mediante **contedores con Docker**
...
- **Porto anfitrión:** 2222 (ou o que decida o usuario)  
- **Porto convidado:** 22  

### Máquinas necesarias en VirtualBox

En VirtualBox teremos unha máquina inicial en **Rede NAT**, e realizaremos **dúas clonacións enlazadas**:
...
Se realizamos a instalación mediante:

```bash
apt install ansible
```

descargarase unha versión antiga, como é **Ansible 2.10**.
